...
def getMatrix(num, args):
    ...
    tag += u'<tr>'
    if int(num) < len(amazon) and amazon :
        tag += u'<td><a href="/"  target="_blank"><img src="/static/images/banner/amazon_p193x40.gif" /></a></td>'
    else:
        tag += u'<td></td>'
    if  int(num) < len(rakuten) and rakuten :
        tag += u'<td><a href="/"  target="_blank"><img src="/static/images/banner/rakuten_p193x40.gif" /></a></td>'
    else:
        tag += u'<td></td>'
    if  int(num) < len(yahoo_s) and yahoo_s:
        tag += u'<td><a href="/"  target="_blank"><img src="/static/images/banner/yahoo_p193x40.gif" /></a></td>'
    else:
        tag += u'<td></td>'
    if  int(num) < len(ponpare) and ponpare:
        tag += u'<td><a href="/"  target="_blank"><img src="/static/images/banner/ponpare_p193x40.gif" /></a></td>'
    else:
        tag += u'<td></td>'
    if  int(num) < len(yahoo_a) and yahoo_a:
        tag += u'<td><a href="/" target="_blank" ><img src="/static/images/banner/yauc_p193x40.gif" /></a></td>'
    else:
        tag += u'<td></td>'
    tag += u'</tr>'
